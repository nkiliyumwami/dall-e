...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    ...
    if (form.prompt) {
      try {
        ...
        //parse the response/data to be able to see it
        const data = await response.json();

        //once we got the response/data, set it to the state
  ...
  //share the generated image/photo with the community
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        ...
        //go back home to be able to see our photo/image
        navigate('/');
      } catch (error) {
        alert(error);
      } finally {
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      >
        <div className='flex flex-col gap-5'>
          ...
          />
          {/* A place where AI generated image will be shown */}
        ...
        {/* Generate and Submitting our form/photo */}
